# This file was generated by this command:
#    bazel sync --experimental_repository_resolved_file=resolved_repos.bzl
# after swapping in the WORKSPACE.sync file temporarily as the WORKSPACE file.
# See the README.md for more details.
# It is often referred to as the resolved.bzl file in Bazel documentation.
...
resolved = [
    ...
    {
        "original_rule_class": "@bazel_tools//tools/build_defs/repo:git.bzl%git_repository",
        "definition_information": "Call stack for the definition of repository 'pomgen' which is a git_repository (rule definition at /private/var/tmp/_bazel_plaird/18d98394c1236332f2dc7e81f73f35ff/external/bazel_tools/tools/build_defs/repo/git.bzl:195:18):\n - <builtin>\n - /Users/plaird/dev/bazel-demo/other_usecases/bazel/resolved-repos/WORKSPACE:102:1",
        "original_attributes": {
            "name": "pomgen",
